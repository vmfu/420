...
export default class MenuPricingPreview extends React.Component {
  render() {
    return (
      ...
      >
        <h2 className="txt-center pop-font txt-white">Завтраки</h2>
        <p className="section-description">
        Каждый кусочек каждого блюда уникальный и особенный. Вам никогда не будет скучно и вы всегда сможете найти для себя что-то новое и интересное. Откройте для себя все аппетитные варианты завтраков, которые мы можем предложить.
        </p>
